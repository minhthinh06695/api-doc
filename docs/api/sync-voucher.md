...
- [Phiếu nhập hàng bán trả lại (setSaleReturn)](sync-voucher/setsalereturn)
- [Phiếu nhập kho (setReceipt)](sync-voucher/setreceipt)
- [Phiếu xuất kho (setIssue)](sync-voucher/setissue)
